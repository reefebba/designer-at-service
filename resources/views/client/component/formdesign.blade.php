  ...
  <div class="row">
    ...
    <div class="col s12 m6">
      <div class="radio">
        ...
        <img id="img-upload" class="shadow img-fluid img-thumbnail mt-2" style="max-width:30%;" src="{{asset('images/pm.jpg')}}" alt="">
      ...
      <div class="radio">
        ...
        <input placeholder="cth. Tambahkan catatan:  Diharap tidak membawa jajanan dari luar" name="add_info">
