<div>
  <div class="d-flex justify-content-between">
    <h5 class="color-primary">Kajian</h5>
  </div>
  ...
  <div class="row">
    ...
    <div class="col s6">
      ...
      <div>
        ...
        <select class="select" style="display: block;" name="type">
    ...
    <div class="col s6">
      ...
      <div>
        ...
        <select class="select" style="display: block;" name="time" id="time">
      ...
      <div class="radio">
        <label  class="label" for="fasting"><i class="fas fa-utensils"><span class="ml-2" style="font-family:ubuntu;"> Apakah disediakan snack/takjil?</span></i></label>
      ...
      <div class="radio">
        <label  class="label" for="stream"><i class="fas fa-tv"><span class="ml-2" style="font-family:ubuntu;"> Apakah bisa streaming online?</span></i></label>
